...
public class UpscaleSqlServerRepository(EzioHostDbContext dbContext) : IUpscaleRepository
{
    ...
    public Task<IEnumerable<VideoUpscale>> GetVideoUpscales(Expression<Func<VideoUpscale, bool>>? expression = null,
        Expression<Func<VideoUpscale, object>>[]? includes = null)
    {
